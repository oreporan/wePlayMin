...
// Saves an object to the DB
  function saveObjectToDB( obj , callback) {
      obj.save(function(err , result) {
        ...
        logger.debug('saveObjectToDBForTest', 'object saved, id - ' + result.id);
        callback(result);
    });
  };
