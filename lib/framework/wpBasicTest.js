...
module.exports.clearDB = require('mocha-mongoose')(config.local);
...
logger.test('generateGame', "Generating a new game for league: " + leagueId);
	...
	var leagueUser = leagueController.generateLeagueUser(client, false);
...
module.exports.generateLeague = function(name, userAdmin, frequency, makeTeamsAtNum, users) {
	...
	league.name = name;
	league.users = users ? users : [leagueController.generateLeagueUser(userAdmin, false)];
...
module.exports.generateLeagueUser = leagueController.generateLeagueUser;
