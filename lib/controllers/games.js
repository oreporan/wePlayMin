...
function addGame(leagueId, matchDay, clientId, callback){
  ...
  Game.addGame(leagueId, matchDay, clientId, function(er , game) {
    ...
    user : function(callback) {
      if(clientId) {
        addUserToGame(leagueId, game.id, clientId, callback);
      }
    },
...
module.exports.closeGame = function(leagueId, gameId, clientId, callback) {
  leagues.getLeagueById(leagueId, function(err, leagueResult){
    if(err != null || leagueResult == null) {
      ...
      return callback('only admins can close games', null);
    } else {
...
module.exports.addGame = function(leagueId, matchDay, clientId, callback) {
  ...
  if(err != null || result == null) {
    ...
    addGame(leagueId, matchDay, clientId, callback);
    }
  });
};
