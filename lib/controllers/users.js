...
module.exports.findOrCreate = function(userName, email, password, authId, callback) {
	// Attempt to add user
	addUser(userName, email, password, authId, function(err, result) {
		// User was created
		if(err == null) {
...
var addUser = module.exports.addUser = function(userName, email, password, authId, callback ) {
	User.addUser(userName, email, password, authId, callback);
};
