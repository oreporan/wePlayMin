...
module.exports.addLeague = function(name, creator, weekDay, gameTime, numOfPlayersPerTeam, makeTeamsAtNum, callback) {
	async.waterfall([
		function(callback) {
...
module.exports.addUserToLeague = function(clientId, leagueId, isInvite, callback) {
	async.parallel({
		...
		league : function(callback) {
			var leagueUser = new LeagueUser(clientId, isInvite);
