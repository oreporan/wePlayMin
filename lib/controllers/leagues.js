...
module.exports.getAllUsersInLeague = function(leagueId, callback) {
	League.getAllUsersInLeague(leagueId, function(err, result) {
		if(err != null || result == null) {
			callback("could not get league: " + leagueId, null);
			return;
		}
		callback(null, result);
	});
...
module.exports.addGameToLeague = function(leagueId, gameId, callback) {
	League.addGameToLeague(leagueId, gameId, function(err, result) {
		if(err != null || result == null) {
			callback("could not add game to league: " + leagueId, null);
			return;
		}
		callback(null, result);
	});
