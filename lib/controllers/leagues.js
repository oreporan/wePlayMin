...
module.exports.addLeague = function(name, admin, frequency, numOfPlayersPerTeam, callback) {
	var games = [];
	League.addLeague(name, admin, frequency, games, [admin], numOfPlayersPerTeam , function(err , leagueResult) {
		if(err != null) {
			callback(err , null);
		} else {
