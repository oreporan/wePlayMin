...
module.exports.addLeague = function(name, creator, frequency, numOfPlayersPerTeam, makeTeamsAtNum, callback) {
	...
	async.waterfall([
		function(callback) {
			League.addLeague(name, creator, [creator], frequency, games, [creator], numOfPlayersPerTeam , makeTeamsAtNum, [], callback);
		},
		function(league, number, callback) {
...
module.exports.addUserToLeague = function(clientId, leagueId, isInvite, callback) {
	users.updateLeagues(clientId, leagueId, true, function(err, result) {
		...
		var userObject = generateLeagueUser(result, isInvite);
		League.addUserToLeague(userObject, leagueId, callback);
	});
};
...
var updateLeague = module.exports.updateLeague = function(leagueId, params, callback) {
	...
	// Helper methods
	var generateLeagueUser = module.exports.generateLeagueUser = function(userObj, isInvite) {
		return {'_id' : userObj._id, 'position' : userObj.position, form : [], isInvite : isInvite,  date: Date()}
	  return result;
	}
