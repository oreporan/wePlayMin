...
function joinGame(req, res) {
  ...
  var clientId = req.get(Constants.CLIENT_ID_HEADER_KEY);
	...
	games.addUserToGame(leagueId, gameId, clientId, function(err, game) {
		if(err != null) {
...
function removeUserFromGame(req, res) {
  ...
  var clientId = req.get(Constants.CLIENT_ID_HEADER_KEY);
	...
	games.removeUserFromGame(leagueId, gameId, clientId, function(err, game) {
		if(err != null) {
...
function closeGame(req, res) {
  ...
  var clientId = req.get(Constants.CLIENT_ID_HEADER_KEY);
	...
	games.closeGame(leagueId, gameId, clientId, function(err, game) {
		if(err != null) {
