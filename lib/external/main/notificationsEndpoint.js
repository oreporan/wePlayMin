...
function markAsRead(req, res) {
	...
	logger.audit('markAsRead' , 'Marking notification ' + note + ' as read for client - ' + clientId);
	wpNotificationManager.markRead(note, function(err, result) {
		...
		logger.audit('markAsRead' ,'notification marked as read');
...
function getNotifications(req, res) {
	...
	wpNotificationManager.getNotifications(notes, function(err, arrayOfNotifications) {
		...
		logger.audit('getNotifications' , arrayOfNotifications.length + ' notifications retrieved');
