...
describe('#addUserToLeagueNotification()', function() {
  it('Create a league, then push a user to that league, expect a notification', function(done) {
...
describe('#addAdminNotification()', function() {
  it('Create a leaugue with an admin, then add another user to the league and make him admin, expect to get a notification', function(done) {
