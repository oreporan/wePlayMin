...
module.exports.addLeague = function(name, creator, admins, frequency, games, users, numOfPlayersPerTeam, makeTeamsAtNum , callback) {
...
module.exports.removeUserFromLeague = function(clientId, leagueId, callback) {
	League.findByIdAndUpdate(leagueId, { $pull: { users: clientId, admins: clientId } }, {new:true}, callback);
};
