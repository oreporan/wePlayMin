...
module.exports.addUser = function(userName, email, password, authId, callback) {
...
module.exports.addNotification = function(receiversIds, notification, callback) {
	User.update({'_id': { $in: receiversIds} }, { $addToSet: { notifications: notification._id } }, {new:true}, function(err, result) {
