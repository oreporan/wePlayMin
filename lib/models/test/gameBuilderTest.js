...
describe('gameBuilder.js, This test classes tests the gamebuilder model', function() {
  ...
  /**
	 ...
	 */
	describe('#buildGameWithMoreThanMax()', function() {
      ...
      var gameObject = {'_id' : 'someGame', users : [
			...
			{'_id' : 'Player2' , attending : 1, isInvite : false},
			{'_id' : 'Player3' , attending : 1, isInvite : false},
			{'_id' : 'Player4' , attending : 1, isInvite : false},
			...
			{'_id' : 'Player9' , attending : 1, isInvite : false}], teamA:[], teamB:[], invites:[], numOfPlayersPerTeam : numOfPlayersPerTeam};
...
describe('#buildGameLessThanMax()', function() {
	it('build a game that is missing a few players ', function(done) {
		...
		{'_id' : 'Player3' , attending : 0, isInvite : false},
...
// 	it('build a game that is missing a few players from the home players, so they must take leagues invites ', function(done) {
// 		var numOfPlayersPerTeam = 10;
...
// 		{'_id' : 'Player7' , attending : -1, isInvite : false},
// 		{'_id' : 'Player8' , attending : 1, isInvite : false},
// 		{'_id' : 'Player9' , attending : 1, isInvite : true},
// 		{'_id' : 'Player10' , attending : 1, isInvite : true},
// 		{'_id' : 'Player11' , attending : 1, isInvite : true}], teamA:[], teamB:[], invites:[], numOfPlayersPerTeam : numOfPlayersPerTeam};
// 		var returnedGame = gameBuilder.buildGame(gameObject);
